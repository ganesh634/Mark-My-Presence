...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        MMPutility.setImage(this, "images/login-background.jpg", 635, 506);
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if("gani123".equalsIgnoreCase(email)&&"gani123".equalsIgnoreCase(password)){
            this.dispose();
            MMPutility.openForm(Dashboard.class.getSimpleName(), new Dashboard());
        }
        else{
